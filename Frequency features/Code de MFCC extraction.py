...
def MFCC(signal, n_fft, hop_size, n_mels, n_mfcc):
    # Calcul de la STFT
...
librosa.display.specshow(MFCC(signal,n_fft,hop_size,n_mels,n_mfcc), x_axis='time', sr=Fs, hop_length=hop_size, cmap='coolwarm')
